...
/**
 * Elering Estfeed (EE) adapter - github.com/Elering/estfeed-datahub-docs. REST,
 * OAuth2-style client-credentials token then a consumption query. Best-documented of
 * the three national DataHubs, built first per ARCH_SPEC.md section 3.2/5.
 */
@Component
